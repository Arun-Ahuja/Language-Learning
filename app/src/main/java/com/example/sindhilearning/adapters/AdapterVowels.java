...
public class AdapterVowels extends RecyclerView.Adapter<AdapterConsonant.MyViewHolder> {
    private ArrayList<VowelBean> rhymesBeans;
    private RecyclerViewClickListener mListener;


    public AdapterVowels(RecyclerViewClickListener mListener, ArrayList<VowelBean> list) {
    ...
    public AdapterConsonant.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        CardView v = (CardView) LayoutInflater.from(parent.getContext()).inflate(R.layout.row_design_vowels, parent, false);
    ...
    public void onBindViewHolder(AdapterConsonant.MyViewHolder holder, int position) {
        ...
        holder.tv_consonent.setText("" + rhymesBeans.get(position).getVowel());
